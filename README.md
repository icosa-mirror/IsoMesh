...
### SDFPrimitives
The SDFPrimitive component is standalone and can represent spheres, rounded cuboids, tori, box frames, cylinders, capsules, ellipsoids, cones, and square pyramids. Each primitive has its own geometry parameters. [Many more signed-distance primitives are possible.](https://www.iquilezles.org/www/articles/distfunctions/distfunctions.htm)
